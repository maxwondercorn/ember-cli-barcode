...
return r}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}self.EmberENV.EXTEND_PROTOTYPES=!1,function(){
/*!
...
t(this,p)
for(var n=arguments.length,r=new Array(n),i=0;i<n;i++)r[i]=arguments[i]
return l(s(e=h.call.apply(h,[this].concat(r))),"tagName","svg"),l(s(e),"thisId",null),l(s(e),"defaultText","Barcode value"),l(s(e),"altText",null),l(s(e),"excludeAltValue",!1),l(s(e),"svgns","http://www.w3.org/2000/svg"),l(s(e),"barcode",null),l(s(e),"defaults",null),e}return a=p,(c=[{key:"envConfig",get:function(){return Ember.getOwner(this).resolveRegistration("config:environment")["ember-cli-barcode"]||{}}},{key:"init",value:function(){var e
r(u(p.prototype),"init",this).apply(this,arguments)
var t={},n=this.envConfig
t.format=this.format||n.format||"CODE128",t.mod43=this.mod43||n.mod43||!1,t.width=this.width||n.width||2,t.height=this.height||n.height||100,t.displayValue=!0,Ember.isBlank(this.displayValue)?Ember.isBlank(n.displayValue)||(t.displayValue=n.displayValue):t.displayValue=this.displayValue,t.font=this.font||n.font||"monospace",t.fontOptions=this.fontOptions||n.fontOptions||"",t.fontSize=this.fontSize||n.fontSize||20,t.textAlign=this.textAlign||n.textAlign||"center",t.textPosition=this.textPosition||n.textPosition||"bottom",t.textMargin=this.textMargin||n.textMargin||2,t.background=this.background||n.background||"#ffffff",t.lineColor=this.lineColor||n.lineColor||"#000000",t.flat=this.flat||n.flat||!1,t.lastChar=this.lastChar||n.lastChar||"",t.margin=null!==(e=this.margin)&&void 0!==e?e:10,t.marginTop=this.marginTop,Ember.isBlank(t.marginTop)&&(t.marginTop=n.marginTop),t.marginBottom=this.marginBottom,Ember.isBlank(t.marginBottom)&&(t.marginBottom=n.marginBottom),t.marginLeft=this.marginLeft,Ember.isBlank(t.marginLeft)&&(t.marginLeft=n.marginLeft),t.marginRight=this.marginRight,Ember.isBlank(t.marginRight)&&(t.marginRight=n.marginRight),this.defaults=t}},{key:"didInsertElement",value:function(){r(u(p.prototype),"didInsertElement",this).apply(this,arguments),this.set("thisId",this.elementId)}},{key:"didRender",value:function(){var e,t=this
r(u(p.prototype),"didRender",this).apply(this,arguments)
...
break
case"CANVAS":this.element.setAttribute("role","img"),this.element.setAttribute("aria-label",o)}i.setTitle&&this.element.setAttribute("title",o)}}}])&&n(a.prototype,c),f&&n(a,f),p}()
